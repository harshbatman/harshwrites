export const articles = [
  ...
  },
  {
    ...
    content: `
      ...
      <div style="margin: 2rem 0; text-align: center;">
        <img src="/indira-gandhi-border-review.jpg" alt="Indira Gandhi reviewing military preparation on border at West Bengal" style="width: 100%; max-width: 800px; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);" />
        <p style="text-align: center; color: #6b7280; font-size: 0.875rem; margin-top: 0.5rem; font-style: italic;">Indira Gandhi reviewing military preparations on the border at West Bengal.</p>
      </div>
      ...
      <div style="margin: 2rem 0; text-align: center;">
        ...
        <p style="font-size: 0.85rem; color: #6b7280; margin-top: 0.5rem; font-style: italic;">The Instrument of Surrender being signed on 16 December 1971 in Dhaka.</p>
      </div>
      ...
      <div style="margin: 2rem 0; text-align: center;">
        <img src="/sam-manekshaw-dhaka.jpg" alt="Sam Manekshaw interacting with people in Dhaka" style="width: 100%; max-width: 800px; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);" />
        <p style="text-align: center; color: #6b7280; font-size: 0.875rem; margin-top: 0.5rem; font-style: italic;">Field Marshal Sam Manekshaw interacting with people in Dhaka after the surrender.</p>
      </div>
      ...
      <div style="margin: 2rem 0; text-align: center;">
        <img src="/indira-gandhi-redfort-1971.jpg" alt="Indira Gandhi reviewing guard of honour at Red Fort" style="width: 100%; max-width: 800px; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);" />
  ...
  },
  {
    ...
    content: `
      ...
      <div class="meta-financial-chart" style="margin: 3rem 0; padding: 2rem; background: #f9fafb; border-radius: 16px; border: 1px solid #e5e7eb;">
        ...
        <div style="display: grid; gap: 1.5rem;">
          ...
          <div style="display: grid; grid-template-columns: 40px 1fr; gap: 12px; align-items: start;">
            <div style="font-size: 0.9rem; font-weight: 600; color: #374151; padding-top: 2px;">2012</div>
            
            <div style="display: flex; flex-direction: column; gap: 6px;">
               <!-- Revenue -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 3.76962962962963%; height: 100%; background: #2563eb; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #2563eb; min-width: 45px; text-align: left;">$5.1B</span>
               </div>

               <!-- Income -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 0.03925925925925926%; height: 100%; background: #16a34a; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #16a34a; min-width: 45px; text-align: left;">$0.1B</span>
               </div>
            </div>
          </div>
          <!-- 2013 -->
          <div style="display: grid; grid-template-columns: 40px 1fr; gap: 12px; align-items: start;">
            <div style="font-size: 0.9rem; font-weight: 600; color: #374151; padding-top: 2px;">2013</div>
            
            <div style="display: flex; flex-direction: column; gap: 6px;">
               <!-- Revenue -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 5.831111111111111%; height: 100%; background: #2563eb; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #2563eb; min-width: 45px; text-align: left;">$7.9B</span>
               </div>

               <!-- Income -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 1.1111111111111112%; height: 100%; background: #16a34a; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #16a34a; min-width: 45px; text-align: left;">$1.5B</span>
               </div>
            </div>
          </div>
          <!-- 2014 -->
          <div style="display: grid; grid-template-columns: 40px 1fr; gap: 12px; align-items: start;">
            <div style="font-size: 0.9rem; font-weight: 600; color: #374151; padding-top: 2px;">2014</div>
            
            <div style="display: flex; flex-direction: column; gap: 6px;">
               <!-- Revenue -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 9.234074074074075%; height: 100%; background: #2563eb; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #2563eb; min-width: 45px; text-align: left;">$12.5B</span>
               </div>

               <!-- Income -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 2.1777777777777776%; height: 100%; background: #16a34a; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #16a34a; min-width: 45px; text-align: left;">$2.9B</span>
               </div>
            </div>
          </div>
          <!-- 2015 -->
          <div style="display: grid; grid-template-columns: 40px 1fr; gap: 12px; align-items: start;">
            <div style="font-size: 0.9rem; font-weight: 600; color: #374151; padding-top: 2px;">2015</div>
            
            <div style="display: flex; flex-direction: column; gap: 6px;">
               <!-- Revenue -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 13.28%; height: 100%; background: #2563eb; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #2563eb; min-width: 45px; text-align: left;">$17.9B</span>
               </div>

               <!-- Income -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 2.7177777777777776%; height: 100%; background: #16a34a; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #16a34a; min-width: 45px; text-align: left;">$3.7B</span>
               </div>
            </div>
          </div>
          <!-- 2016 -->
          <div style="display: grid; grid-template-columns: 40px 1fr; gap: 12px; align-items: start;">
            <div style="font-size: 0.9rem; font-weight: 600; color: #374151; padding-top: 2px;">2016</div>
            
            <div style="display: flex; flex-direction: column; gap: 6px;">
               <!-- Revenue -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 20.472592592592594%; height: 100%; background: #2563eb; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #2563eb; min-width: 45px; text-align: left;">$27.6B</span>
               </div>

               <!-- Income -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 7.568148148148149%; height: 100%; background: #16a34a; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #16a34a; min-width: 45px; text-align: left;">$10.2B</span>
               </div>
            </div>
          </div>
          <!-- 2017 -->
          <div style="display: grid; grid-template-columns: 40px 1fr; gap: 12px; align-items: start;">
            <div style="font-size: 0.9rem; font-weight: 600; color: #374151; padding-top: 2px;">2017</div>
            
            <div style="display: flex; flex-direction: column; gap: 6px;">
               <!-- Revenue -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 30.11333333333333%; height: 100%; background: #2563eb; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #2563eb; min-width: 45px; text-align: left;">$40.7B</span>
               </div>

               <!-- Income -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 11.802962962962962%; height: 100%; background: #16a34a; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #16a34a; min-width: 45px; text-align: left;">$15.9B</span>
               </div>
            </div>
          </div>
          <!-- 2018 -->
          <div style="display: grid; grid-template-columns: 40px 1fr; gap: 12px; align-items: start;">
            <div style="font-size: 0.9rem; font-weight: 600; color: #374151; padding-top: 2px;">2018</div>
            
            <div style="display: flex; flex-direction: column; gap: 6px;">
               <!-- Revenue -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 41.36148148148148%; height: 100%; background: #2563eb; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #2563eb; min-width: 45px; text-align: left;">$55.8B</span>
               </div>

               <!-- Income -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 16.379259259259257%; height: 100%; background: #16a34a; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #16a34a; min-width: 45px; text-align: left;">$22.1B</span>
               </div>
            </div>
          </div>
          <!-- 2019 -->
          <div style="display: grid; grid-template-columns: 40px 1fr; gap: 12px; align-items: start;">
            <div style="font-size: 0.9rem; font-weight: 600; color: #374151; padding-top: 2px;">2019</div>
            
            <div style="display: flex; flex-direction: column; gap: 6px;">
               <!-- Revenue -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 52.36814814814815%; height: 100%; background: #2563eb; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #2563eb; min-width: 45px; text-align: left;">$70.7B</span>
               </div>

               <!-- Income -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 13.692592592592593%; height: 100%; background: #16a34a; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #16a34a; min-width: 45px; text-align: left;">$18.5B</span>
               </div>
            </div>
          </div>
          <!-- 2020 -->
          <div style="display: grid; grid-template-columns: 40px 1fr; gap: 12px; align-items: start;">
            <div style="font-size: 0.9rem; font-weight: 600; color: #374151; padding-top: 2px;">2020</div>
            
            <div style="display: flex; flex-direction: column; gap: 6px;">
               <!-- Revenue -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 63.67777777777778%; height: 100%; background: #2563eb; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #2563eb; min-width: 45px; text-align: left;">$86.0B</span>
               </div>

               <!-- Income -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 21.58962962962963%; height: 100%; background: #16a34a; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #16a34a; min-width: 45px; text-align: left;">$29.1B</span>
               </div>
            </div>
          </div>
          <!-- 2021 -->
          <div style="display: grid; grid-template-columns: 40px 1fr; gap: 12px; align-items: start;">
            <div style="font-size: 0.9rem; font-weight: 600; color: #374151; padding-top: 2px;">2021</div>
            
            <div style="display: flex; flex-direction: column; gap: 6px;">
               <!-- Revenue -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 87.35481481481482%; height: 100%; background: #2563eb; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #2563eb; min-width: 45px; text-align: left;">$117.9B</span>
               </div>

               <!-- Income -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 29.16296296296296%; height: 100%; background: #16a34a; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #16a34a; min-width: 45px; text-align: left;">$39.4B</span>
               </div>
            </div>
          </div>
          <!-- 2022 -->
          <div style="display: grid; grid-template-columns: 40px 1fr; gap: 12px; align-items: start;">
            <div style="font-size: 0.9rem; font-weight: 600; color: #374151; padding-top: 2px;">2022</div>
            
            <div style="display: flex; flex-direction: column; gap: 6px;">
               <!-- Revenue -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 86.37703703703703%; height: 100%; background: #2563eb; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #2563eb; min-width: 45px; text-align: left;">$116.6B</span>
               </div>

               <!-- Income -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 17.185185185185183%; height: 100%; background: #16a34a; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #16a34a; min-width: 45px; text-align: left;">$23.2B</span>
               </div>
            </div>
          </div>
          <!-- 2023 -->
          <div style="display: grid; grid-template-columns: 40px 1fr; gap: 12px; align-items: start;">
            <div style="font-size: 0.9rem; font-weight: 600; color: #374151; padding-top: 2px;">2023</div>
            
            <div style="display: flex; flex-direction: column; gap: 6px;">
               <!-- Revenue -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 99.9274074074074%; height: 100%; background: #2563eb; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #2563eb; min-width: 45px; text-align: left;">$134.9B</span>
               </div>

               <!-- Income -->
               <div style="display: flex; align-items: center; gap: 10px;">
                  <div style="flex: 1; max-width: 100%; height: 20px; background: rgba(229, 231, 235, 0.3); border-radius: 4px; overflow: visible; position: relative;">
                     <div style="width: 28.96148148148148%; height: 100%; background: #16a34a; border-radius: 4px; display: flex; align-items: center; transition: width 1s ease;"></div>
                  </div>
                  <span style="font-size: 0.85rem; font-weight: 600; color: #16a34a; min-width: 45px; text-align: left;">$39.1B</span>
               </div>
            </div>
          </div>
        </div>
        <div style="margin-top: 2rem; display: flex; gap: 2rem; justify-content: center; font-size: 0.85rem; color: #6b7280; padding-top: 1rem; border-top: 1px dashed #e5e7eb;">
            <div style="display: flex; align-items: center; gap: 8px;"><div style="width: 12px; height: 12px; background: #2563eb; border-radius: 4px;"></div> Revenue (USD Billions)</div>
            <div style="display: flex; align-items: center; gap: 8px;"><div style="width: 12px; height: 12px; background: #16a34a; border-radius: 4px;"></div> Net Income (USD Billions)</div>
        </div>
      </div>

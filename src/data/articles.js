export const articles = [
  ...
  },
  {
    ...
    content: `
      ...
      <div style="margin: 2rem 0; text-align: center;">
        <img src="/sam-manekshaw-dhaka.jpg" alt="Field Marshal Sam Manekshaw interacting with people in Dhaka after Pakistan surrender" style="width: 100%; max-width: 800px; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);" />
        <p style="text-align: center; color: #6b7280; font-size: 0.875rem; margin-top: 0.5rem; font-style: italic;">Field Marshal Sam Manekshaw interacting with people in Dhaka after Pakistan surrender.</p>
      </div>
